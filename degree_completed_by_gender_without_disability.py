...
male = [
    get_degree_info("male", False, "high_school_graduate_(includes_equivalency)"),
    get_degree_info("male", False, "associate_degree"),
    get_degree_info("male", False, "bachelors_degree"),
    get_degree_info("male", False, "graduate_or_professional_degree"),
]
female = [
    get_degree_info("female", False, "high_school_graduate_(includes_equivalency)"),
    get_degree_info("female", False, "associate_degree"),
    get_degree_info("female", False, "bachelors_degree"),
    get_degree_info("female", False, "graduate_or_professional_degree"),
]
...
plt.title("Degree completed by gender without disability")
